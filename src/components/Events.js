...
const Events = () => {
  // Upcoming events - currently empty, check back soon!
        ...
        <div className="text-center mb-12">
          ...
          >
            {upcomingEvents.length > 0
              ? 'Join us at our upcoming workshops, social dances, and special events. More events will be announced soon!'
              : 'Check out highlights from our recent events. More events coming soon!'}
          </motion.p>
        </div>

        {/* Events grid or Past Event Showcase */}
        {upcomingEvents.length > 0 ? (
          ...
          /* Coming Soon message when no upcoming events */
          <motion.div
          ...
          >
            ...
            <p className="text-primary-light">
              Stay tuned for our upcoming workshops, social dances, and special events.
            </p>
          </motion.div>
        )}
