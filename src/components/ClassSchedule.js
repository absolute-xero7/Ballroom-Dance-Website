...
const fallSchedule = [
    {
        ...
        classes: [
            { date: 'Sep 17', name: 'Cha Cha Cha' },
            { date: 'Sep 24', name: 'Slow Waltz' },
            { date: 'Oct 1', name: 'Disco Fox' },
        ],
    },
    {
        month: 'October',
    ...
    },
    {
        month: 'November',
        classes: [
            { date: 'Nov 5', name: 'Slow Waltz' },
            { date: 'Nov 12', name: 'Vienna Waltz' },
            { date: 'Nov 19', name: 'Vienna Waltz' },
            { date: 'Nov 26', name: 'Grand Recap' },
        ],
    },
];
