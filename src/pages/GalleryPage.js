...
const GalleryPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Ballroom Dance Society | Gallery</title>
        <meta name="description" content="View photos and memories from Ballroom Dance Society events and classes at UofT." />
        <meta property="og:title" content="Ballroom Dance Society | Gallery" />
        <meta property="og:description" content="View photos and memories from Ballroom Dance Society events and classes at UofT." />
