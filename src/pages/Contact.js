...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Ballroom Dance Society | Contact</title>
        <meta name="description" content="Contact the Ballroom Dance Society at the University of Toronto. Get in touch for questions, collaborations, or joining our club." />
        <meta property="og:title" content="Ballroom Dance Society | Contact" />
        <meta property="og:description" content="Contact the Ballroom Dance Society at the University of Toronto. Get in touch for questions, collaborations, or joining our club." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ballroomdanceuoft.com/contact" />
      </Helmet>
              ...
              >
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <a href="mailto:ballroomdance.uoft@studentorg.utoronto.ca" className="inline-flex items-center bg-primary text-white px-4 py-2 rounded-full hover:bg-accent transition-colors">
                  ...
                  <div className="mt-8">
                    ...
                    <div className="flex space-x-4">
                      <a href="https://www.instagram.com/ballroomdance_uoft/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center bg-primary text-white px-4 py-2 rounded-full hover:bg-accent transition-colors">
